package com.lims.manage.erp.aspect;

import com.alibaba.fastjson.JSON;
import com.lims.manage.erp.annotation.Log;
import com.lims.manage.erp.config.PropertyPreExcludeFilter;
...
import com.lims.manage.erp.enums.BusinessStatus;
import com.lims.manage.erp.enums.HttpMethod;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            if (userInfo != null)
            {
                operLog.setOperName(userInfo.getName());
                //获取所属部门

                operLog.setDeptName(userInfo.getDepartment());
            }
